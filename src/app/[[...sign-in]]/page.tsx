...
const LoginPage = () => {
    ...
    return (
        <div className='h-screen flex items-center justify-center bg-sSkyLight'>
            <SignIn.Root>
                <SignIn.Step name='start' className='bg-white p-12 rounded-md shadow-2xl wflex flex-col gap-2'>
                    <h1 className='text-xl font-bold flex items-center gap-2'>
                        <Image src='/logo.png' alt='' width={24} height={24} />
                        Informacioni sistem skole</h1>
                    <h2 className='text-gray-400'>Prijavite se na svoj nalog</h2>
                ...
                <Clerk.Field name='password' className='flex flex-col gap-2'>
                    <Clerk.Label className='text-xs text-gray-500'>Lozinka</Clerk.Label>
